...
if (accessChart.max_dataset_acc) {
    let configDatasetAccess = getDoughnutChar(
        accessChart.dataset_accessibility, accessChart.max_dataset_acc, 'Dataset Accessibility',
...
if (accessChart.max_url_acc) {
    let configURLAccess = getDoughnutChar(
        accessChart.url_accessibility, accessChart.max_url_acc, 'URL Accessibility',
        accessChart.darkColor, accessChart.lightColor
    );
