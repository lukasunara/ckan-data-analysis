...
if (reuseChart.max_license > 0) {
    let configLicense = getDoughnutChar(
        reuseChart.license, reuseChart.max_license, 'License',
...
if (reuseChart.max_basic_info > 0) {
    let configBasicInfo = getDoughnutChar(
        reuseChart.basic_info, reuseChart.max_basic_info, 'Basic Data Informations',
        reuseChart.darkColor, reuseChart.lightColor
    );
...
if (reuseChart.max_extras > 0) {
    let configExtras = getDoughnutChar(
        reuseChart.extras, reuseChart.max_extras, 'Extra Data Informations',
        reuseChart.darkColor, reuseChart.lightColor
    );
...
if (reuseChart.max_publisher > 0) {
    let configPublisher = getDoughnutChar(
        reuseChart.publisher, reuseChart.max_publisher, 'Publisher',
        reuseChart.darkColor, reuseChart.lightColor
    );
